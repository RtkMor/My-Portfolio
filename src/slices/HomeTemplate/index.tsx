...
/**
 * Props for `HomeTemplate`.
 */
export type HomeTemplateProps = SliceComponentProps<Content.HomeTemplateSlice>;

/**
 * Component for "HomeTemplate" Slices.
 */
const HomeTemplate = ({ slice }: HomeTemplateProps): JSX.Element => {
