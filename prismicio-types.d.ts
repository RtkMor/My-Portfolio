...
interface BlogPostDocumentData {
  ...
  /**
   * Github Link field in *Blog Post*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: blog_post.github_link
   * - **Tab**: Main
...
type HomepageDocumentDataSlicesSlice = HomeTemplateSlice;
...
/**
 * Item in *Education → Default → Primary → Education List*
 */
export interface EducationSliceDefaultPrimaryEducationListItem {
  /**
   * Name field in *Education → Default → Primary → Education List*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: education.default.primary.education_list[].name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  name: prismic.KeyTextField;

  /**
   * Marks field in *Education → Default → Primary → Education List*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: education.default.primary.education_list[].marks
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  marks: prismic.KeyTextField;
}
...
export interface EducationSliceDefaultPrimary {
  ...
  /**
   * Education List field in *Education → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: education.default.primary.education_list[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  education_list: prismic.GroupField<
...
/**
 * Item in *ExtraTechList → Default → Primary → Extra Tech List*
 */
export interface ExtraTechListSliceDefaultPrimaryExtraTechListItem {
  /**
   * Tech Field field in *ExtraTechList → Default → Primary → Extra Tech List*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: extra_tech_list.default.primary.extra_tech_list[].tech_field
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  tech_field: prismic.KeyTextField;

  /**
   * Tech Color field in *ExtraTechList → Default → Primary → Extra Tech List*
   *
   * - **Field Type**: Color
   * - **Placeholder**: *None*
   * - **API ID Path**: extra_tech_list.default.primary.extra_tech_list[].tech_color
...
/**
 * Primary content in *ExtraTechList → Default → Primary*
 */
export interface ExtraTechListSliceDefaultPrimary {
  /**
   * Heading field in *ExtraTechList → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: extra_tech_list.default.primary.heading
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  heading: prismic.KeyTextField;

  /**
   * Extra Tech List field in *ExtraTechList → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: extra_tech_list.default.primary.extra_tech_list[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  extra_tech_list: prismic.GroupField<
    Simplify<ExtraTechListSliceDefaultPrimaryExtraTechListItem>
  >;
}

/**
 * Default variation for ExtraTechList Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ExtraTechListSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<ExtraTechListSliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *ExtraTechList*
 */
type ExtraTechListSliceVariation = ExtraTechListSliceDefault;

/**
 * ExtraTechList Shared Slice
 *
 * - **API ID**: `extra_tech_list`
 * - **Description**: ExtraTechList
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ExtraTechListSlice = prismic.SharedSlice<
  "extra_tech_list",
  ExtraTechListSliceVariation
>;

/**
 * Primary content in *HomeTemplate → Default → Primary*
 */
export interface HomeTemplateSliceDefaultPrimary {
  /**
   * First Name field in *HomeTemplate → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: home_template.default.primary.first_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  first_name: prismic.KeyTextField;

  /**
   * Last Name field in *HomeTemplate → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: home_template.default.primary.last_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  last_name: prismic.KeyTextField;

  /**
   * Tag Line field in *HomeTemplate → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: home_template.default.primary.tag_line
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
/**
 * Default variation for HomeTemplate Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type HomeTemplateSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<HomeTemplateSliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *HomeTemplate*
 */
type HomeTemplateSliceVariation = HomeTemplateSliceDefault;

/**
 * HomeTemplate Shared Slice
 *
 * - **API ID**: `home_template`
 * - **Description**: HomeTemplate
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type HomeTemplateSlice = prismic.SharedSlice<
  "home_template",
  HomeTemplateSliceVariation
>;
...
/**
 * Item in *WorkExperience → Default → Primary → Work Experience List*
 */
export interface WorkExperienceSliceDefaultPrimaryWorkExperienceListItem {
  /**
   * Name field in *WorkExperience → Default → Primary → Work Experience List*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: work_experience.default.primary.work_experience_list[].name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  name: prismic.KeyTextField;

  /**
   * Date field in *WorkExperience → Default → Primary → Work Experience List*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: work_experience.default.primary.work_experience_list[].date
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  date: prismic.KeyTextField;

  /**
   * Location field in *WorkExperience → Default → Primary → Work Experience List*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: work_experience.default.primary.work_experience_list[].location
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  location: prismic.KeyTextField;

  /**
   * Description field in *WorkExperience → Default → Primary → Work Experience List*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: work_experience.default.primary.work_experience_list[].description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  description: prismic.RichTextField;
}
...
export interface WorkExperienceSliceDefaultPrimary {
  ...
  /**
   * Work Experience List field in *WorkExperience → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: work_experience.default.primary.work_experience_list[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  work_experience_list: prismic.GroupField<
    Simplify<WorkExperienceSliceDefaultPrimaryWorkExperienceListItem>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      ExtraTechListSlice,
      ExtraTechListSliceDefaultPrimaryExtraTechListItem,
      ExtraTechListSliceDefaultPrimary,
      ExtraTechListSliceVariation,
      ExtraTechListSliceDefault,
      HomeTemplateSlice,
      HomeTemplateSliceDefaultPrimary,
      HomeTemplateSliceVariation,
      HomeTemplateSliceDefault,
      TechListSlice,
      ...
      WorkExperienceSlice,
      WorkExperienceSliceDefaultPrimaryWorkExperienceListItem,
